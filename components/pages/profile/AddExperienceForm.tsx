    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className={`block w-full px-3 py-2 md:px-4 md:py-3 border rounded-lg text-sm md:text-base outline-none transition-colors focus:border-gray-500 focus:ring-2 focus:ring-gray-300/60 bg-white ${
      ...
      <div className="flex flex-col gap-1">
        ...
        <textarea
          ...
          className="block w-full px-3 py-2 md:px-4 md:py-3 border border-gray-300 rounded-lg text-sm md:text-base outline-none transition-colors focus:border-gray-500 focus:ring-2 focus:ring-gray-300/60 bg-white resize-none"
        />
      </div>
    </div>
  );
