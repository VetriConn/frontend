 ...
 *
 * There was a `showRetry` prop alongside `onRetry`, defaulting to true, and
 * no caller ever set it. Two props were asking one question: whether to offer
 * the button. Handing over `onRetry` is the answer, and a caller with nothing
 * to retry simply leaves it out.
 */
